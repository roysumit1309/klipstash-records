...
function describeAuthError(code) {
  switch (code) {
    ...
    case "invalid_client":
      // By far the most likely cause, because a project ends up with
      // several clients and only one of them works in a browser.
      return "Google did not recognise that client id. It must be the WEB client from your Google Cloud project - a Desktop or Android client will not work here.";
    default:
